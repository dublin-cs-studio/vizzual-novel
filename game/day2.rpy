label day2:
    ...
    mc "(Quite a bit happened today, didn't it? Is the rest of my life going to be like this? Every day, I wake up, eat, go to work, return, eat, and sleep. I don't want that, it seems so plain.)"
    mc "*yawn*"
    with fade
    ...
    show joejoe happy 1
    with dissolve
    mc "(Sure enough, I spot an aggressively average man drinking coffee instead of water. He spots me too, and waves at me.)"
    ...
    show sigma pain
    s "Ugh."
    mc "(Woah, the two are like night and day.)"
    ...
    s "That's cause you don't wrap the burger in napkins. If you don't want oily hands, then take the step to protect yourself. That's not a valid point."
    s "Besides, isn't pizza oily as well?  Like, considerably more oily than burgers?"
...
label burger:
    ...
    j "*sigh*"
    j "Fine."
    mc "(Joe Joe seems annoyed at Sigma's smug attitude. I feel bad for him since I kinda betrayed him.)"
    show sigma excited at offscreenright
    with ease
    ...
    with dissolve
    mc "(Joe Joe hasn't gotten in line yet. He's still thinking about his order.)"
    mc "(A group of people just walked in. Joe Joe's still not in line yet and they're gonna take his spot.)"
    mc "Joe Joe."
...
label pizza:
    ...
    show sigma pain
    mc "(Sigma looks at me like I've betrayed her.)"
    ...
    show joejoe happy 4 at right
    with dissolve
    mc "(Joe Joe seems the same way, though I think it's more of him loving pizza rather than not caring about the heat.)"
    mc "(His expression is that of bliss, like a buddhist who has achieved nirvana. I really wanna ruffle his hair, but he'll probably find it weird.)"
    ...
    show joejoe neutral
    mc "(He looks at me blankly. I quickly look away."
    mc "(Next, he looks at Sigma and a slight smile appears on his face.)"
    show joejoe talking 1
